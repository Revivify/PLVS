...
RUN dnf -qy install vim-enhanced vim-syntastic vim-syntastic-html vim-syntastic-sh vim-syntastic-c vim-syntastic-php vim-syntastic-ansible vim-syntastic-javascript
